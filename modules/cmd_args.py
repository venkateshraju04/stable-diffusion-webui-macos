...
parser.add_argument("--skip-torch-cuda-test", action='store_true', help="launch.py argument: skip GPU test (always skipped on macOS, uses MPS)")
parser.add_argument("--reinstall-xformers", action='store_true', help="does not do anything (xformers not available on macOS)")
...
parser.add_argument("--xformers", action='store_true', help="does not do anything (xformers not available on macOS/MPS)")
parser.add_argument("--force-enable-xformers", action='store_true', help="does not do anything (xformers not available on macOS/MPS)")
parser.add_argument("--xformers-flash-attention", action='store_true', help="does not do anything (xformers not available on macOS/MPS)")
...
# --use-ipex removed (macOS-only fork, no Intel XPU support)
...
# --device-id removed (CUDA-specific, macOS uses MPS automatically)
